...
<head>
    ...
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script> <!--Bibliothèque jquery (framework de javascript--> 
...
<body>
   ...
   <?php 
    ...
    {
    ?>
    <b><?php echo $msg['pseudo']; ?> : </b> <b><?php echo $msg['message']; ?> </b> <br />
    <?php 
    }
    ?>
    </div>
